...
function apoc_primary_menu() {
	locate_template( array( 'lib/templates/menu-primary.php' ), true );
}

// Sidebar
function apoc_primary_sidebar() {
	locate_template( array( 'lib/templates/sidebar-primary.php' ), true );
}

// Comment Respond Form
function apoc_comment_form() {
	locate_template( array( 'lib/templates/respond.php' ), true );
}
...
function apoc_get_search_form( $search_type = '' ) {
	...
	locate_template( array( 'lib/templates/searchform.php' ), true );
}
