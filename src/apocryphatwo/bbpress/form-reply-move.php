	...
	<fieldset class="move-form">
		<ol class="move-form-fields">
			...
			<li id="split-method" class="form-left">
				...
				<label for="bbp_reply_move_option_reply">Create a new topic with the title:</label>
				<input type="text" id="bbp_reply_move_destination_title" value="<?php printf( __( 'Moved: %s', 'bbpress' ), bbp_get_reply_title() ); ?>" tabindex="<?php bbp_tab_index(); ?>" size="40" name="bbp_reply_move_destination_title" /><br><br>
