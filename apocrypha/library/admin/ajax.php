...
4.0 - COMMENTS
----------------------------------------------*/
add_action( 'apoc_ajax_nopriv_apoc_load_comments' , 'apoc_load_comments' );
add_action( 'apoc_ajax_apoc_load_comments' 		, 'apoc_load_comments' );
 ...
 * @version 1.0.0
 */
add_action( 'apoc_ajax_apoc_delete_comment' , 'apoc_delete_comment' );
